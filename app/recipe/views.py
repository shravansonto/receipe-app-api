...
from recipe.serializers import RecipeSerializer,TagSerializer, RecipeDetailSerializer, IngredientSerializer, RecipeImageSerializer
    ...
    list = extend_schema(
        parameters=[
            OpenApiParameter(
                ...
                description='filter by items assinged to recipe'
            )
        ]
    )
)
